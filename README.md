# 言起 YANQI for Obsidian：把 Markdown 笔记一键导出成多平台图文卡片
...
![Douyin](https://img.shields.io/badge/Douyin-Image%20Posts-111827)
![Bilibili](https://img.shields.io/badge/Bilibili-Image%20Posts-00A1D6)

> **好内容，不该埋在笔记里。**
>
> YANQI 是一个面向内容创作者的 Obsidian 图文导出插件，把 Markdown 笔记一键渲染成适合小红书 / RedNote、抖音图文、Bilibili 图文、公众号、即刻、微博传播的视觉卡片。

![言起 YANQI 演示](image.png)

一键将 Obsidian 笔记渲染为高质感品牌内容图的高级输出引擎。支持 Markdown to image、小红书图文卡片、抖音图文卡片、Bilibili 图文卡片、公众号文章卡片、信息流长图、批量导出和 AI Agent 安装工作流。
...
- **抖音图文 / Bilibili 图文创作者**：把教程、观点、清单和复盘拆成多页信息流图片。
...
| 小红书 / RedNote 图文发布 | 生成封面 + 多页内容图，适合直接发布 |
| 抖音图文 / Bilibili 图文发布 | 把教程、技术总结、产品复盘拆成连续图片 |
...
YANQI 是一个 Obsidian 图文导出插件：你只管写 Markdown，它负责把笔记变成小红书 / RedNote、抖音图文、Bilibili 图文、公众号、即刻、微博都能用的视觉卡片，支持封面风格、主题模板、图片裁剪和批量导出。
...
- **12 套骨架模板** — 小红书、抖音图文、Bilibili 图文、微博、公众号、报纸、语录、终端、GitHub 卡……一键换壳。
...
### YANQI 可以把 Obsidian 笔记导出成小红书、抖音、Bilibili 图文图片吗？

可以。YANQI 会按标题或分隔线把 Markdown 笔记切成多张图文卡片，适合生成小红书 / RedNote、抖音图文、Bilibili 图文的封面图和内容页。


### 支持批量导出多张图吗？

支持。你可以下载当前页，也可以一键导出全部页面，适合一次性生成完整的小红书、抖音、Bilibili 图文组图。
...
不只。小红书 / RedNote 是核心场景，抖音图文和 Bilibili 图文也能直接用。YANQI 同样适合公众号摘要卡、即刻长文卡、微博图文、朋友圈转发图和技术博客视觉摘要。
...
- 增加更多多平台封面模板，尤其是小红书、抖音图文、Bilibili 图文常用的大字报、对比型、清单型和技术趋势型封面。
- 完善 YANQI-note skills 联动教程，让 Agent 同时生成正文、图文卡片内容和导出指令。
- 补充视频教程和从 Obsidian 到小红书 / 抖音图文 / Bilibili 图文发布的完整案例。
- 适配更多社媒平台比例和导出尺寸。
